...
<form action="" method="POST">
    ...
    <input type="text" name="title" id="title" value = "<?php $book["title"] ?? ""?>">
    <p class="error"><?= $errors["title"] ?? ""?></p>

    <label for="author"> Author <span>*</span></label>
    <input type="text" name="author" id="author" value = "<?php $book["author"] ?? ""?>">
    <p class="error"><?= $errors["author"] ?? ""?></p>

    <label for="genre"> Genre <span>*</span></label>
    <select name="genre" id="genre" value = "<?php $book["genre"]?>">
    ...
    <input type="number" name="publication_year" id="publication_year" value = "<?php $book["publication_year"] ?? ""?>">
    <p class="error"><?= $errors["publication_year"] ?? "" ?></p>

    <label for="publisher"> Publisher </label>
    <input type="text" name="publisher" id="publisher" value = "<?php $book["publisher"] ?? ""?>">

    <label for="copies"> Copies <span>*</span> </label>
    <input type="number" name="copies" id="copies" value = "<?php $book["copies"] ?? ""?>">
