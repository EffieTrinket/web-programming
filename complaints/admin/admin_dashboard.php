...
$complaints = $registerObj->filterComplaints($category, $department_id);
?>
        ...
        <?php if (!empty($complaints)): ?>
            <?php foreach ($complaints as $complaint): ?>
                <tr>
                    ...
                    <td>
                        <a href="../Student/view_complaint.php?id=<?= urlencode($complaint['complaint_id']) ?>">View</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
